...
extern struct thread *pid_array[256];
	    ...
	    struct thread **ret)
{
	...
	/* Allocate a stack */
	//DEBUG(1,"Problem start\n");
	newguy->t_stack = kmalloc(STACK_SIZE);//Allocates page before faulting
	//DEBUG(1,"Problem end\n");
